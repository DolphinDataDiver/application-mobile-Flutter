...
class _RandomUserClient implements RandomUserClient {
  ...
  @override
  Future<RandomUserResponse> getRandomUsers(int results) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'results': results};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RandomUserResponse>(
    ...
    late RandomUserResponse _value;
    try {
      _value = RandomUserResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
